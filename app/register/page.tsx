...
import { handleSocialLogin } from "@/lib/utils/social-auth"
...
export default function RegisterPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { error } = await handleSocialLogin(supabase, "google")
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      const { error } = await handleSocialLogin(supabase, "github")
      if (error) throw new Error(error)
